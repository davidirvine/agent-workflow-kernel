...
The implementation-completion gate in `CLAUDE.md` requires all applicable tests to pass. The kernel's gate is the **smoke-app** check — proof that the generator produces a working app:
...
- the smoke-app gate passes (once built)
