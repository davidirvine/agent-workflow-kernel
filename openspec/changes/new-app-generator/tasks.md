...
- [x] 4.5 Substitute identity (per design D4):
...
- [x] 8.2 Push the branch; confirm CI: the `generate-assert` job is green alongside the slice-1 and slice-2 jobs; `smoke-app` stub is still present and green.
